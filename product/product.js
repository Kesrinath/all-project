...
let section1 = document.querySelector("#Men");
let Clothing = document.querySelector(".clothing1");
let cardContainer = document.querySelector("#clothing-cards");
let heading1 = document.createElement("h2");
heading1.classList.add("section-heading");
heading1.innerText = "Clothing for Men and Women";
Clothing.appendChild(heading1);
for (let current = 0; current < 5; current++) {
  let x = buildcard(productList[current]);
  cardContainer.appendChild(x);
}
console.log(Clothing);
Clothing.appendChild(cardContainer);
section1.appendChild(Clothing);

/// for acceseroies details
let section = document.querySelector("#acceseroies");
let Clothing1 = document.querySelector(".clothing");
let heading = document.createElement("h2");
heading.classList.add("section-heading");
heading.innerText = "Accessories for Men and Women";
Clothing1.appendChild(heading);
